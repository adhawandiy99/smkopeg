...
<link rel="manifest" href="/_manifest.json?1.5">
...
<div id="page">
    ...
    <div class="header-bar header-fixed header-app header-auto-show">
        ...
        <a href="#" class="header-title">Back</a>
        ...
        <div class="pt-3">
            <div class="page-title d-flex">
                ...
                <div class="align-self-center me-auto">
                    <h1 class="color-theme mb-0 font-18">@yield('tittle')</h1>
                </div>
                <div class="align-self-center ms-auto">
                    <a href="#"
                    data-bs-toggle="offcanvas" data-bs-target="#menu-sidebar"
                    class="icon  shadow-bg shadow-bg-s rounded-m">
                        <img src="/assets/images/aicrone-logo.png" width="45" alt="img">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="content">
                @if($type)
                    <div class="alert bg-green-light shadow-bg shadow-bg-m alert-dismissible rounded-s fade show mb-0" role="alert">
                       ...
                       <strong>Awesome</strong> - {!! session('alerts')['text'] !!}!
                ...
                @else
                    <div class="alert bg-fade-red color-red-dark alert-dismissible rounded-s fade show" role="alert">
                       ...
                       <strong>Fail</strong> - {!! session('alerts')['text'] !!}
...
<div id="menu-sidebar" data-menu-active="nav-welcome" class="offcanvas offcanvas-end offcanvas-detached rounded-m">
    ...
    <div class="menu-size" style="width:230px;">
        ...
        <div class="pt-3">
            ...
            <div class="list-group list-custom list-menu-large">
                <a href="/approval_tl" class="list-group-item">
                    <i class="bi  bg-brown-dark shadow-bg shadow-bg-xs bi-card-checklist"></i>
                    <div>Approval TL</div>
                </a>
                <a href="/approval_spv" class="list-group-item">
                    <i class="bi bg-brown-dark shadow-bg shadow-bg-xs bi-bookmark-check"></i>
                    <div>Approval SPV</div>
                </a>
                <a href="/order_issued" class="list-group-item">
                    <i class="bi bg-brown-dark shadow-bg shadow-bg-xs bi-card-list"></i>
                    <div>Order Issued</div>
                </a>
...
<div class="offcanvas offcanvas-bottom rounded-m offcanvas-detached" id="menu-install-pwa-ios">
   ...
   <img src="/mobile/app/icons/icon-128x128.png" alt="img" width="80" class="rounded-m mx-auto my-4">
      <h1 class="text-center">Install SMPRO</h1>
      <p class="boxed-text-xl">
          Install SMPRO on your home screen, and access it just like a regular app. Open your Safari menu and tap "Add to Home Screen".
      </p>
...
<div class="offcanvas offcanvas-bottom rounded-m offcanvas-detached" id="menu-install-pwa-android">
   <div class="content">
       ...
       <p class="boxed-text-l">
           Install SMPRO to your Home Screen to enjoy a unique and native experience.
       </p>
...
<script src="/mobile/scripts/custom.js?1.5"></script>
<script type="text/javascript">
    ...
    const elem = document.querySelector('#footer-bar')
    elem.querySelectorAll('a').forEach(el => el.addEventListener('click', e => {
        if (el.getAttribute('href') !== '#') {
            document.getElementById("preloader").classList.remove("preloader-hide");
        }
    }));

    const id_user = <?= json_encode(session('auth')->id_user); ?>;
    console.log(id_user);
    // Function to set id_user in local storage
    ...
    function checkUserSession() {
        // Check if id_user is available in local storage
        const storedId = localStorage.getItem('id_user');

        if (storedId==id_user) {
            console.log('User ID from local storage:', storedId);
            // Optionally, you can validate against the server or perform further actions
        } else {
            // If no user ID is found, store the new id_user
            if (id_user) {
                setUserId(id_user);
                console.log('User ID set from session:', id_user);
            } else {
    ...
    // Call the session checker function
    checkUserSession();
