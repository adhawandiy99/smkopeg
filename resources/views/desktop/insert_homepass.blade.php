          ...
          <div class="mb-3 fv-row">
            ...
            <div class="invalid-feedback">Please provide an ISP.</div>
    			...
    			<div class="mb-3 fv-row">
			        ...
			        <textarea name="paste" class="form-control" id="paste" placeholder="homepass_id|homepass_koordinat|region|sub_region|provinsi|kota|kecamatan|kelurahan|kode_pos|spliter_distribusi_koordinat|splitter_id|resident_name|nama_jalan_|no_rumah_gedung|unit|resident_category|homepass_status|resident_type" autocomplete="off" required>{{ $data->paste ?? old('paste') }}</textarea>
