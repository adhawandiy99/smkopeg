			...
			<div class="d-flex flex-column flex-column-fluid flex-lg-row">
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
					<div class="d-flex flex-center flex-lg-start flex-column">
						...
						<!--end::Logo-->
						<!--begin::Title-->
						<!-- <h2 class="text-white fw-normal m-0">Telkomakses</h2> -->
						<!--end::Title-->
					</div>
				</div>
				<div class="d-flex flex-column-fluid flex-row-auto p-20">
					<div class="bg-body d-flex flex-column align-items-stretch rounded-4 h-md-400px p-20">
						<div class="d-flex flex-column flex-column-fluid ">
							<form class="form" novalidate="novalidate" id="kt_sign_in_form" method="post" action="/login">
								<div class="text-center mb-11">
									<h1 class="text-gray-900 fw-bolder mb-3">Sales Management</h1>
									<h3 class="text-muted mb-3">Sign In</h1>
								</div>
								@if ($errors->any())
								...
								<a href="https://t.me/SM_Kopegtel_bot" target="_BLANK" class="link-primary">Sign up</a></div>
							</form>
						</div>
					</div>
				</div>
