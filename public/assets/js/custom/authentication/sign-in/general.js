    ...
    init: function () {
      (t = document.querySelector("#kt_sign_in_form")),
        ...
        (r = FormValidation.formValidation(t, {
          fields: {
            username: { validators: { notEmpty: { message: "Email address is required" } } },
                  ...
                  "Valid" == r
                    ? (e.setAttribute("data-kt-indicator", "on"),
                      ...
                      axios
                        ...
                        .then(function (e) {
                          if (e) {
                            t.reset(), Swal.fire({ text: "You have successfully logged in!", icon: "success", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } });
